...
var SunCardContent = /*#__PURE__*/function () {
  ...
  _createClass(SunCardContent, null, [{
    ...
    value: function generateBody(data, config) {
      var _data$sunPercentOverH, _data$sunPercentOverH2, _data$dawnProgressPer, _data$dawnProgressPer2, _data$dayProgressPerc, _data$dayProgressPerc2, _data$duskProgressPer, _data$duskProgressPer2, _data$sunPosition$x, _data$sunPosition$y, _data$sunPosition$x2, _data$sunPosition$y2, _data$sunPosition$x3, _data$sunPosition$y3;
