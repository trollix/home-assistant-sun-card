...
class SunCardContent {
    ...
    static generateBody(data, config) {
        ...
        const lightenedColor = this.lightenColor(config.sunColor, 50);
        return x `
...
let SunCard = class SunCard extends s {
    constructor() {
        super();
...
SunCard.cardType = 'sun-card';
SunCard.cardName = 'Sun Card';
SunCard.cardDescription = 'Custom card that display a graph to track the sun position and related events';
__decorate([
    n$1({ attribute: false })
], SunCard.prototype, "hasRendered", void 0);
__decorate([
    n$1({ attribute: false })
], SunCard.prototype, "lastHass", void 0);
__decorate([
    t()
], SunCard.prototype, "config", void 0);
__decorate([
    t()
], SunCard.prototype, "data", void 0);
__decorate([
    n$1({ attribute: false })
], SunCard, "cardType", void 0);
__decorate([
    n$1({ attribute: false })
], SunCard, "cardName", void 0);
__decorate([
    n$1({ attribute: false })
], SunCard, "cardDescription", void 0);
SunCard = __decorate([
    e$1('sun-card')
], SunCard);
